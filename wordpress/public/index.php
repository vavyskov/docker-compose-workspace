...
<header class="bg-dark text-white mb-5 pt-4 pb-3 sticky-top">
    <div class="container">
        <div class="media">
            <img src='assets/lightbulb.svg' alt='lightbulb' width='72' height='96' class='align-middle'>
            <div class="media-body pl-3">
                <h1>It works!</h1>
                <p class="lead">
                    The web server is up and running!
                    <img src='assets/smile-wink.svg' alt='smile-wink' width='20' height='21' class='align-middle'>
                </p>
            </div>
        </div>
    </div>
...
<footer class="bg-dark text-white-50 pt-3 pb-1 mt-5 fixed-bottom">
    <div class="container">
        <p class="text-center">Web server info VeV-VA Vyškov</p>
    </div>
</footer>
